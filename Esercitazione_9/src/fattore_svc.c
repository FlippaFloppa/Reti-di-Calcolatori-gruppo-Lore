...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, FATTORE, FACTVERS, fattore_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (FATTORE, FACTVERS, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, FATTORE, FACTVERS, fattore_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (FATTORE, FACTVERS, tcp).");
		exit(1);
	}
